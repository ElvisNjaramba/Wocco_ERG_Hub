...
//     <div 
//       ref={ref} 
//       className="group relative mb-6 transition-all duration-200 hover:bg-gray-50/50 rounded-2xl p-2"
//     >
...
//               className="mb-3 px-4 py-2 rounded-xl bg-gradient-to-r from-[#432dd7]/10 to-purple-500/10 border border-[#432dd7]/20 cursor-pointer transition-all hover:scale-[1.02] hover:shadow-md"
//             >
...
//             <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200 hover:border-gray-300 transition-all group-hover:shadow-md">
...
//                     >
//                       <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#432dd7]/20 to-purple-500/20 flex items-center justify-center">
//                         <File className="w-6 h-6 text-[#432dd7]" />
//                       </div>
//                       <div className="flex-1 min-w-0">
...
//       {/* Messages List */}
// <div className="flex-1 overflow-y-auto p-6 bg-gradient-to-b from-white to-gray-50/50 space-y-4">
//   {messages.map((msg) => (
//     <MessageItem
//       key={msg.id}
//       msg={msg}
...
//       {/* Reply Preview */}
//       {replyTo && (
//         <div className="border-t border-gray-100 bg-gradient-to-r from-[#432dd7]/5 to-purple-500/5 p-4">
//           <div className="flex items-center justify-between">
//             <div className="flex items-center gap-3">
...
//             className="flex-1 min-h-[80px] p-4 pr-24 rounded-2xl border-2 border-gray-200 focus:border-[#432dd7] focus:ring-2 focus:ring-[#432dd7]/20 focus:outline-none resize-none transition-all"
//             rows="2"
//           />
...
//           </div>
//           <div>
//             Press <kbd className="px-2 py-1 bg-gray-100 rounded text-sm">Enter</kbd> to send
//           </div>
//         </div>
//       </div>
//     </div>
...
//           className="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-gradient-to-r from-[#432dd7] to-purple-600 text-white shadow-2xl flex items-center justify-center hover:scale-110 transition-transform"
